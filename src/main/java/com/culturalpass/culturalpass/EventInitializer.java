    ...
    public void initEvents() {
        if (eventRepository.count() == 0) {
            Event event = Event.builder()
                    ...
                    .startDate(java.time.OffsetDateTime.of(2025, 11, 22, 20, 0, 0, 0, java.time.ZoneOffset.UTC))
                    .endDate(java.time.OffsetDateTime.of(2025, 11, 22, 23, 0, 0, 0, java.time.ZoneOffset.UTC))
